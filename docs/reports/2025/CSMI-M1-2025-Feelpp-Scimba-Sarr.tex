...
\begin{figure}[H]
    \centering
    \includegraphics[width=\textwidth, keepaspectratio]{conv_Feelpp.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.5\textwidth]{Feelpp_Solution.png}
    \includegraphics[width=0.5\textwidth]{Scimba_Solution.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.7\textwidth]{Feelpp_Error.png}
    \includegraphics[width=0.7\textwidth]{Scimba_Error.png}
    \captionsetup{font=Large}
...
\begin{figure}[H]
    ...
    \begin{minipage}[t]{0.5\textwidth}
        \centering
        \includegraphics[width=\textwidth]{conv_Feelpp.png}
...
\begin{figure}[H]
    ...
    \begin{minipage}[t]{0.49\textwidth}
        \centering
        \includegraphics[width=\textwidth]{mu01_uFeelpp_Solution_uExact_uErr.png}
        \caption{Solution for $\mu=0.1$}
    \end{minipage}
    \hfill
    \begin{minipage}[t]{0.49\textwidth}
        \centering
        \includegraphics[width=\textwidth]{mu05_uFeelpp_Solution_uExact_uErr.png}
        \caption{Solution for $\mu=0.5$}
    \end{minipage}
    \vspace{1em} % Add some vertical space between rows of figures
    \begin{minipage}[t]{0.49\textwidth}
        \centering
        \includegraphics[width=\textwidth]{mu1_uFeelpp_Solution_uExact_uErr.png}
        \caption{Solution for $\mu=1.0$}
    \end{minipage}
    \hfill
    \begin{minipage}[t]{0.49\textwidth}
        \centering
        \includegraphics[width=\textwidth]{mu2_uFeelpp_Solution_uExact_uErr.png}
...
\begin{figure}[H]
    ...
    \begin{minipage}[t]{0.48\textwidth}
        \centering
        \includegraphics[width=\textwidth]{01_conv.png}
        \caption{Convergence for $\mu=0.1$}
    \end{minipage}
    \hfill
    \begin{minipage}[t]{0.48\textwidth}
        \centering
        \includegraphics[width=\textwidth]{05_conv.png}
        \caption{Convergence for $\mu=0.5$}
    \end{minipage}
    \vspace{1em} % Add some vertical space between rows of figures
    \begin{minipage}[t]{0.48\textwidth}
        \centering
        \includegraphics[width=\textwidth]{1_conv.png}
        \caption{Convergence for $\mu=1.0$}
    \end{minipage}
    \hfill
    \begin{minipage}[t]{0.48\textwidth}
        \centering
        \includegraphics[width=\textwidth]{2_conv.png}
